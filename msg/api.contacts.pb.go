...
func (dst *ContactsImport) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ContactsImport.Merge(dst, src)
}
...
func (dst *ContactsGet) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ContactsGet.Merge(dst, src)
}
...
func (dst *ContactsDelete) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ContactsDelete.Merge(dst, src)
}
...
func (dst *ContactsImported) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ContactsImported.Merge(dst, src)
}
...
func (dst *ContactsMany) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ContactsMany.Merge(dst, src)
}
