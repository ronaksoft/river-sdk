...
func (*EchoWithDelay) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_dev_7d6a69386a33ba80, []int{0}
}
...
func (dst *EchoWithDelay) XXX_Merge(src proto.Message) {
	xxx_messageInfo_EchoWithDelay.Merge(dst, src)
}
...
func (m *EchoWithDelay) MarshalTo(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x8
	i++
	i = encodeVarintApiDev(dAtA, i, uint64(m.DelayInSeconds))
	return i, nil
}

func encodeVarintApiDev(dAtA []byte, offset int, v uint64) int {
	for v >= 1<<7 {
...
func (m *EchoWithDelay) Size() (n int) {
	...
	var l int
	_ = l
	n += 1 + sovApiDev(uint64(m.DelayInSeconds))
	return n
}

func sovApiDev(x uint64) (n int) {
	for {
		n++
		x >>= 7
		if x == 0 {
...
func sozApiDev(x uint64) (n int) {
	return sovApiDev(uint64((x << 1) ^ uint64((int64(x) >> 63))))
}
func (m *EchoWithDelay) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		default:
			iNdEx = preIndex
			skippy, err := skipApiDev(dAtA[iNdEx:])
			if err != nil {
				return err
			}
			if skippy < 0 {
				return ErrInvalidLengthApiDev
			}
			if (iNdEx + skippy) > l {
				return io.ErrUnexpectedEOF
			}
...
func skipApiDev(dAtA []byte) (n int, err error) {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		var wire uint64
		...
		case 2:
			...
			iNdEx += length
			if length < 0 {
				return 0, ErrInvalidLengthApiDev
			}
			return iNdEx, nil
		case 3:
			for {
				...
				next, err := skipApiDev(dAtA[start:])
				if err != nil {
					return 0, err
				}
				iNdEx = start + next
...
var (
	ErrInvalidLengthApiDev = fmt.Errorf("proto: negative length found during unmarshaling")
	ErrIntOverflowApiDev   = fmt.Errorf("proto: integer overflow")
)

func init() { proto.RegisterFile("api.dev.proto", fileDescriptor_api_dev_7d6a69386a33ba80) }

var fileDescriptor_api_dev_7d6a69386a33ba80 = []byte{
	// 119 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0xe2, 0x4d, 0x2c, 0xc8, 0xd4,
	0x4b, 0x49, 0x2d, 0xd3, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0x62, 0xce, 0x2d, 0x4e, 0x57, 0xb2,
	0xe5, 0xe2, 0x75, 0x4d, 0xce, 0xc8, 0x0f, 0xcf, 0x2c, 0xc9, 0x70, 0x49, 0xcd, 0x49, 0xac, 0x14,
	0xd2, 0xe1, 0xe2, 0x03, 0x33, 0x3c, 0xf3, 0x82, 0x53, 0x93, 0xf3, 0xf3, 0x52, 0x8a, 0x25, 0x18,
	0x15, 0x98, 0x34, 0x58, 0x9d, 0x58, 0x4e, 0xdc, 0x93, 0x67, 0x08, 0x42, 0x93, 0x73, 0x92, 0x38,
	0xf1, 0x48, 0x8e, 0xf1, 0xc2, 0x23, 0x39, 0xc6, 0x07, 0x8f, 0xe4, 0x18, 0x27, 0x3c, 0x96, 0x63,
	0xb8, 0xf0, 0x58, 0x8e, 0xe1, 0xc6, 0x63, 0x39, 0x06, 0x40, 0x00, 0x00, 0x00, 0xff, 0xff, 0xa1,
	0xe2, 0xd2, 0x52, 0x6d, 0x00, 0x00, 0x00,
}
