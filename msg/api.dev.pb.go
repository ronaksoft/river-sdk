...
func (*EchoWithDelay) Descriptor() ([]byte, []int) {
	return fileDescriptor_9a5c46af97fa8931, []int{0}
}
...
func init() { proto.RegisterFile("api.dev.proto", fileDescriptor_9a5c46af97fa8931) }

var fileDescriptor_9a5c46af97fa8931 = []byte{
