...
// 	fmt.Println("Add Bar", b.Min, b.Max, b.Type)
// 	switch b.Type {
// 	case Hole:
...
// }
//
// func (m *HoleManager) updateBars() []Bar {
...
// 						break
// 					}
// 					if pts[endIdx+1].Index == pts[endIdx].Index+1 {
// 						switch pts[endIdx+1].Type {
// 						case HoleStart:
// 							// Merge Neighborhoods
// 							endIdx += 2
// 						default:
...
// 	m.insertBar(Bar{Type: Filled, Min: 0, Max: m.minIndex})
// }
//
