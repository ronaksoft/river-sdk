...
var file_core_types_proto_rawDesc = []byte{
	...
	0x74, 0x22, 0xec, 0x03, 0x0a, 0x06, 0x44, 0x69, 0x61, 0x6c, 0x6f, 0x67, 0x12, 0x1a, 0x0a, 0x06,
...
var file_core_types_proto_goTypes = []interface{}{
	...
	(*Ack)(nil),                   // 18: msg.Ack
	(*Bool)(nil),                  // 19: msg.Bool
	(*Dialog)(nil),                // 20: msg.Dialog
	(*InputPeer)(nil),             // 21: msg.InputPeer
	(*Peer)(nil),                  // 22: msg.Peer
	(*InputPassword)(nil),         // 23: msg.InputPassword
	(*InputFileLocation)(nil),     // 24: msg.InputFileLocation
	(*FileLocation)(nil),          // 25: msg.FileLocation
	(*WebLocation)(nil),           // 26: msg.WebLocation
	(*InputWebLocation)(nil),      // 27: msg.InputWebLocation
	(*UserPhoto)(nil),             // 28: msg.UserPhoto
	(*InputUser)(nil),             // 29: msg.InputUser
	(*User)(nil),                  // 30: msg.User
	(*ContactUser)(nil),           // 31: msg.ContactUser
	(*Bot)(nil),                   // 32: msg.Bot
	(*BotCommands)(nil),           // 33: msg.BotCommands
	(*BotInfo)(nil),               // 34: msg.BotInfo
	(*GroupPhoto)(nil),            // 35: msg.GroupPhoto
	(*Group)(nil),                 // 36: msg.Group
	(*GroupFull)(nil),             // 37: msg.GroupFull
	(*GroupParticipant)(nil),      // 38: msg.GroupParticipant
	(*UserMessage)(nil),           // 39: msg.UserMessage
	(*ReactionCounter)(nil),       // 40: msg.ReactionCounter
	(*DraftMessage)(nil),          // 41: msg.DraftMessage
	(*MessageEntity)(nil),         // 42: msg.MessageEntity
	(*RSAPublicKey)(nil),          // 43: msg.RSAPublicKey
	(*DHGroup)(nil),               // 44: msg.DHGroup
	(*PhoneContact)(nil),          // 45: msg.PhoneContact
	(*PeerNotifySettings)(nil),    // 46: msg.PeerNotifySettings
	(*InputFile)(nil),             // 47: msg.InputFile
	(*InputDocument)(nil),         // 48: msg.InputDocument
	(*PrivacyRule)(nil),           // 49: msg.PrivacyRule
	(*Label)(nil),                 // 50: msg.Label
	(*LabelsMany)(nil),            // 51: msg.LabelsMany
	(*InputGeoLocation)(nil),      // 52: msg.InputGeoLocation
	(*GeoLocation)(nil),           // 53: msg.GeoLocation
	(*InputTeam)(nil),             // 54: msg.InputTeam
	(*TeamPhoto)(nil),             // 55: msg.TeamPhoto
	(*Team)(nil),                  // 56: msg.Team
	(*rony.MessageEnvelope)(nil),  // 57: rony.MessageEnvelope
}
var file_core_types_proto_depIdxs = []int32{
	14, // 0: msg.UpdateContainer.Updates:type_name -> msg.UpdateEnvelope
	30, // 1: msg.UpdateContainer.Users:type_name -> msg.User
	36, // 2: msg.UpdateContainer.Groups:type_name -> msg.Group
	57, // 3: msg.ProtoEncryptedPayload.Envelope:type_name -> rony.MessageEnvelope
	46, // 4: msg.Dialog.NotifySettings:type_name -> msg.PeerNotifySettings
	41, // 5: msg.Dialog.Draft:type_name -> msg.DraftMessage
	1,  // 6: msg.InputPeer.Type:type_name -> msg.PeerType
	25, // 7: msg.UserPhoto.PhotoBig:type_name -> msg.FileLocation
	25, // 8: msg.UserPhoto.PhotoSmall:type_name -> msg.FileLocation
	26, // 9: msg.UserPhoto.PhotoBigWeb:type_name -> msg.WebLocation
	26, // 10: msg.UserPhoto.PhotoSmallWeb:type_name -> msg.WebLocation
	2,  // 11: msg.User.Status:type_name -> msg.UserStatus
	28, // 12: msg.User.Photo:type_name -> msg.UserPhoto
	28, // 13: msg.User.PhotoGallery:type_name -> msg.UserPhoto
	34, // 14: msg.User.BotInfo:type_name -> msg.BotInfo
	28, // 15: msg.ContactUser.Photo:type_name -> msg.UserPhoto
	32, // 16: msg.BotInfo.Bot:type_name -> msg.Bot
	33, // 17: msg.BotInfo.BotCommands:type_name -> msg.BotCommands
	25, // 18: msg.GroupPhoto.PhotoBig:type_name -> msg.FileLocation
	25, // 19: msg.GroupPhoto.PhotoSmall:type_name -> msg.FileLocation
	3,  // 20: msg.Group.Flags:type_name -> msg.GroupFlags
	35, // 21: msg.Group.Photo:type_name -> msg.GroupPhoto
	36, // 22: msg.GroupFull.Group:type_name -> msg.Group
	30, // 23: msg.GroupFull.Users:type_name -> msg.User
	38, // 24: msg.GroupFull.Participants:type_name -> msg.GroupParticipant
	46, // 25: msg.GroupFull.NotifySettings:type_name -> msg.PeerNotifySettings
	35, // 26: msg.GroupFull.PhotoGallery:type_name -> msg.GroupPhoto
	4,  // 27: msg.GroupParticipant.Type:type_name -> msg.ParticipantType
	28, // 28: msg.GroupParticipant.Photo:type_name -> msg.UserPhoto
	42, // 29: msg.UserMessage.Entities:type_name -> msg.MessageEntity
	6,  // 30: msg.UserMessage.MediaType:type_name -> msg.MediaType
	40, // 31: msg.UserMessage.Reactions:type_name -> msg.ReactionCounter
	42, // 32: msg.DraftMessage.Entities:type_name -> msg.MessageEntity
	7,  // 33: msg.MessageEntity.Type:type_name -> msg.MessageEntityType
	10, // 34: msg.PrivacyRule.PrivacyType:type_name -> msg.PrivacyType
	50, // 35: msg.LabelsMany.Labels:type_name -> msg.Label
	25, // 36: msg.TeamPhoto.PhotoBig:type_name -> msg.FileLocation
	25, // 37: msg.TeamPhoto.PhotoSmall:type_name -> msg.FileLocation
	11, // 38: msg.Team.Flags:type_name -> msg.TeamFlags
	55, // 39: msg.Team.Photo:type_name -> msg.TeamPhoto
