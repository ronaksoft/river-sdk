...
type CallConnection struct {
	...
	ReconnectingTry     bool                   `protobuf:"varint,8,opt,name=ReconnectingTry,proto3" json:"ReconnectingTry,omitempty"`
...
func (x *CallConnection) GetReconnectingTry() bool {
	if x != nil {
...
var file_client_call_proto_rawDesc = []byte{
	...
	0x72, 0x79, 0x18, 0x08, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0f, 0x52, 0x65, 0x63, 0x6f, 0x6e, 0x6e,
