...
func (x *PublicGetUserInfo) Clone() *PublicGetUserInfo {
	z := &PublicGetUserInfo{}
	x.DeepCopy(z)
	return z
}
...
func (x *PublicGetUserInfo) UnmarshalJSON(b []byte) error {
	return protojson.Unmarshal(b, x)
}

func (x *PublicGetUserInfo) MarshalJSON() ([]byte, error) {
...
func (x *UserInfo) Clone() *UserInfo {
	z := &UserInfo{}
	x.DeepCopy(z)
	return z
}
...
func (x *UserInfo) UnmarshalJSON(b []byte) error {
	return protojson.Unmarshal(b, x)
}

func (x *UserInfo) MarshalJSON() ([]byte, error) {
	return protojson.Marshal(x)
}
