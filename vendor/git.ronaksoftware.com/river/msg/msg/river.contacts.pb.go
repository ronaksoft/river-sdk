...
func (TopPeerCategory) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_c1bd200b0c501de9, []int{0}
}
...
func (*ContactsAdd) Descriptor() ([]byte, []int) {
	return fileDescriptor_c1bd200b0c501de9, []int{1}
}
...
func (*ContactsGet) Descriptor() ([]byte, []int) {
	return fileDescriptor_c1bd200b0c501de9, []int{2}
}
...
func (*ContactsDelete) Descriptor() ([]byte, []int) {
	return fileDescriptor_c1bd200b0c501de9, []int{3}
}
...
func (*ContactsDeleteAll) Descriptor() ([]byte, []int) {
	return fileDescriptor_c1bd200b0c501de9, []int{4}
}
...
func (*ContactsBlock) Descriptor() ([]byte, []int) {
	return fileDescriptor_c1bd200b0c501de9, []int{5}
}
...
func (*ContactsUnblock) Descriptor() ([]byte, []int) {
	return fileDescriptor_c1bd200b0c501de9, []int{6}
}
...
func (*ContactsGetBlocked) Descriptor() ([]byte, []int) {
	return fileDescriptor_c1bd200b0c501de9, []int{7}
}
...
func (*ContactsSearch) Descriptor() ([]byte, []int) {
	return fileDescriptor_c1bd200b0c501de9, []int{8}
}
...
func (*ContactsGetTopPeers) Descriptor() ([]byte, []int) {
	return fileDescriptor_c1bd200b0c501de9, []int{9}
}
...
func (*ContactsResetTopPeer) Descriptor() ([]byte, []int) {
	return fileDescriptor_c1bd200b0c501de9, []int{10}
}
...
func (*ContactsTopPeers) Descriptor() ([]byte, []int) {
	return fileDescriptor_c1bd200b0c501de9, []int{11}
}
...
func (*TopPeer) Descriptor() ([]byte, []int) {
	return fileDescriptor_c1bd200b0c501de9, []int{12}
}
...
func (*BlockedContactsMany) Descriptor() ([]byte, []int) {
	return fileDescriptor_c1bd200b0c501de9, []int{13}
}
...
func (*BlockedContact) Descriptor() ([]byte, []int) {
	return fileDescriptor_c1bd200b0c501de9, []int{14}
}
...
type ContactsImported struct {
	...
	Users        []*User        `protobuf:"bytes,2,rep,name=Users" json:"Users,omitempty"`
	Empty        bool           `protobuf:"varint,3,opt,name=Empty" json:"Empty"`
}
...
func (*ContactsImported) Descriptor() ([]byte, []int) {
	return fileDescriptor_c1bd200b0c501de9, []int{15}
}
...
func (*ContactsMany) Descriptor() ([]byte, []int) {
	return fileDescriptor_c1bd200b0c501de9, []int{16}
}
...
func init() { proto.RegisterFile("river.contacts.proto", fileDescriptor_c1bd200b0c501de9) }

var fileDescriptor_c1bd200b0c501de9 = []byte{
	// 750 bytes of a gzipped FileDescriptorProto
	,
}
		...
		for iNdEx := len(m.Contacts) - 1; iNdEx >= 0; iNdEx-- {
			{
				...
				i -= size
				i = encodeVarintRiverContacts(dAtA, i, uint64(size))
			}
			i--
			dAtA[i] = 0xa
		}
...
func (m *ContactsAdd) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	i -= len(m.Phone)
	copy(dAtA[i:], m.Phone)
	i = encodeVarintRiverContacts(dAtA, i, uint64(len(m.Phone)))
	i--
	dAtA[i] = 0x22
	i -= len(m.LastName)
	copy(dAtA[i:], m.LastName)
	i = encodeVarintRiverContacts(dAtA, i, uint64(len(m.LastName)))
	i--
	dAtA[i] = 0x1a
	i -= len(m.FirstName)
	copy(dAtA[i:], m.FirstName)
	i = encodeVarintRiverContacts(dAtA, i, uint64(len(m.FirstName)))
	i--
	dAtA[i] = 0x12
	if m.User == nil {
...
func (m *ContactsGet) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	i = encodeVarintRiverContacts(dAtA, i, uint64(m.Crc32Hash))
	i--
	dAtA[i] = 0x10
	return len(dAtA) - i, nil
}
...
func (m *ContactsDelete) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.UserIDs) > 0 {
		for iNdEx := len(m.UserIDs) - 1; iNdEx >= 0; iNdEx-- {
			i = encodeVarintRiverContacts(dAtA, i, uint64(m.UserIDs[iNdEx]))
			i--
			dAtA[i] = 0x8
		}
	}
...
func (m *ContactsGetBlocked) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	i = encodeVarintRiverContacts(dAtA, i, uint64(m.Limit))
	i--
	dAtA[i] = 0x10
	i = encodeVarintRiverContacts(dAtA, i, uint64(m.Offset))
	i--
	dAtA[i] = 0x8
	return len(dAtA) - i, nil
}
...
func (m *ContactsSearch) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	i -= len(m.Q)
	copy(dAtA[i:], m.Q)
	i = encodeVarintRiverContacts(dAtA, i, uint64(len(m.Q)))
	i--
	dAtA[i] = 0xa
	return len(dAtA) - i, nil
}
...
func (m *ContactsGetTopPeers) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	i = encodeVarintRiverContacts(dAtA, i, uint64(m.Category))
	i--
	dAtA[i] = 0x18
	i = encodeVarintRiverContacts(dAtA, i, uint64(m.Limit))
	i--
...
func (m *ContactsTopPeers) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	i = encodeVarintRiverContacts(dAtA, i, uint64(m.Count))
	i--
	dAtA[i] = 0x10
	i = encodeVarintRiverContacts(dAtA, i, uint64(m.Category))
	i--
...
func (m *TopPeer) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	i = encodeVarintRiverContacts(dAtA, i, uint64(m.LastUpdate))
	i--
	dAtA[i] = 0x18
	i -= 4
...
func (m *BlockedContactsMany) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	i = encodeVarintRiverContacts(dAtA, i, uint64(m.Total))
	i--
	dAtA[i] = 0x18
	if len(m.Users) > 0 {
		for iNdEx := len(m.Users) - 1; iNdEx >= 0; iNdEx-- {
...
func (m *BlockedContact) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	i = encodeVarintRiverContacts(dAtA, i, uint64(m.Date))
	i--
	dAtA[i] = 0x10
	i = encodeVarintRiverContacts(dAtA, i, uint64(m.UserID))
	i--
	dAtA[i] = 0x8
	return len(dAtA) - i, nil
}
...
func encodeVarintRiverContacts(dAtA []byte, offset int, v uint64) int {
	offset -= sovRiverContacts(v)
	base := offset
	for v >= 1<<7 {
...
func (m *ContactsImport) Size() (n int) {
	...
	if len(m.Contacts) > 0 {
		for _, e := range m.Contacts {
			l = e.Size()
			n += 1 + l + sovRiverContacts(uint64(l))
		}
	}
	n += 2
	return n
...
func (m *ContactsGet) Size() (n int) {
	...
	var l int
	_ = l
	n += 1 + sovRiverContacts(uint64(m.Crc32Hash))
	return n
}
...
func (m *ContactsGetBlocked) Size() (n int) {
	...
	var l int
	_ = l
	n += 1 + sovRiverContacts(uint64(m.Offset))
	n += 1 + sovRiverContacts(uint64(m.Limit))
	return n
}
...
func (m *ContactsGetTopPeers) Size() (n int) {
	...
	n += 1 + sovRiverContacts(uint64(m.Offset))
	n += 1 + sovRiverContacts(uint64(m.Limit))
	n += 1 + sovRiverContacts(uint64(m.Category))
	return n
}
...
func (m *ContactsTopPeers) Size() (n int) {
	...
	_ = l
	n += 1 + sovRiverContacts(uint64(m.Category))
	n += 1 + sovRiverContacts(uint64(m.Count))
	if len(m.Peers) > 0 {
...
func (m *TopPeer) Size() (n int) {
	...
	n += 5
	n += 1 + sovRiverContacts(uint64(m.LastUpdate))
	return n
}
...
func (m *BlockedContactsMany) Size() (n int) {
	...
	n += 1 + sovRiverContacts(uint64(m.Total))
	return n
}
...
func (m *BlockedContact) Size() (n int) {
	...
	var l int
	_ = l
	n += 1 + sovRiverContacts(uint64(m.UserID))
	n += 1 + sovRiverContacts(uint64(m.Date))
	return n
}
...
func sovRiverContacts(x uint64) (n int) {
	return (math_bits.Len64(x|1) + 6) / 7
}
func sozRiverContacts(x uint64) (n int) {
	return sovRiverContacts(uint64((x << 1) ^ uint64((int64(x) >> 63))))
}
func (m *ContactsImport) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		for shift := uint(0); ; shift += 7 {
			if shift >= 64 {
				return ErrIntOverflowRiverContacts
			}
			if iNdEx >= l {
		...
		case 1:
			...
			if msglen < 0 {
				return ErrInvalidLengthRiverContacts
			}
		...
		default:
			iNdEx = preIndex
			skippy, err := skipRiverContacts(dAtA[iNdEx:])
			if err != nil {
				return err
			}
			if skippy < 0 {
...
func skipRiverContacts(dAtA []byte) (n int, err error) {
	l := len(dAtA)
	iNdEx := 0
	depth := 0
	for iNdEx < l {
		...
		for shift := uint(0); ; shift += 7 {
			if shift >= 64 {
				return 0, ErrIntOverflowRiverContacts
			}
			if iNdEx >= l {
		...
		case 2:
			...
			if length < 0 {
				return 0, ErrInvalidLengthRiverContacts
			}
			iNdEx += length
		case 3:
			depth++
		case 4:
			if depth == 0 {
				return 0, ErrUnexpectedEndOfGroupRiverContacts
			}
			depth--
		case 5:
			iNdEx += 4
...
var (
	ErrInvalidLengthRiverContacts        = fmt.Errorf("proto: negative length found during unmarshaling")
	ErrIntOverflowRiverContacts          = fmt.Errorf("proto: integer overflow")
	ErrUnexpectedEndOfGroupRiverContacts = fmt.Errorf("proto: unexpected end of group")
)
