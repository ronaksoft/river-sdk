...
func (*UsersGet) Descriptor() ([]byte, []int) {
	return fileDescriptor_e2c69f25baf143c6, []int{0}
}
...
func (*UsersGetFull) Descriptor() ([]byte, []int) {
	return fileDescriptor_e2c69f25baf143c6, []int{1}
}
...
func (*UsersMany) Descriptor() ([]byte, []int) {
	return fileDescriptor_e2c69f25baf143c6, []int{2}
}
...
func (m *UsersMany) GetEmpty() bool {
	if m != nil {
		return m.Empty
	}
	return false
...
func init() { proto.RegisterFile("river.users.proto", fileDescriptor_e2c69f25baf143c6) }

var fileDescriptor_e2c69f25baf143c6 = []byte{
	// 181 bytes of a gzipped FileDescriptorProto
	,
}
		...
		for iNdEx := len(m.Users) - 1; iNdEx >= 0; iNdEx-- {
			{
				...
				i -= size
				i = encodeVarintRiverUsers(dAtA, i, uint64(size))
			}
			i--
			dAtA[i] = 0xa
		}
...
func encodeVarintRiverUsers(dAtA []byte, offset int, v uint64) int {
	offset -= sovRiverUsers(v)
	base := offset
	for v >= 1<<7 {
...
func sovRiverUsers(x uint64) (n int) {
	return (math_bits.Len64(x|1) + 6) / 7
}
func sozRiverUsers(x uint64) (n int) {
	return sovRiverUsers(uint64((x << 1) ^ uint64((int64(x) >> 63))))
}
func (m *UsersGet) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		for shift := uint(0); ; shift += 7 {
			if shift >= 64 {
				return ErrIntOverflowRiverUsers
			}
			if iNdEx >= l {
		...
		case 1:
			...
			if msglen < 0 {
				return ErrInvalidLengthRiverUsers
			}
		...
		default:
			iNdEx = preIndex
			skippy, err := skipRiverUsers(dAtA[iNdEx:])
			if err != nil {
				return err
			}
			if skippy < 0 {
...
func skipRiverUsers(dAtA []byte) (n int, err error) {
	l := len(dAtA)
	iNdEx := 0
	depth := 0
	for iNdEx < l {
		...
		for shift := uint(0); ; shift += 7 {
			if shift >= 64 {
				return 0, ErrIntOverflowRiverUsers
			}
			if iNdEx >= l {
		...
		case 2:
			...
			if length < 0 {
				return 0, ErrInvalidLengthRiverUsers
			}
			iNdEx += length
		case 3:
			depth++
		case 4:
			if depth == 0 {
				return 0, ErrUnexpectedEndOfGroupRiverUsers
			}
			depth--
		case 5:
			iNdEx += 4
...
var (
	ErrInvalidLengthRiverUsers        = fmt.Errorf("proto: negative length found during unmarshaling")
	ErrIntOverflowRiverUsers          = fmt.Errorf("proto: integer overflow")
	ErrUnexpectedEndOfGroupRiverUsers = fmt.Errorf("proto: unexpected end of group")
)
