...
func New(callback *Callback) *call {
	...
	c.RegisterHandlers(
		map[int64]domain.LocalHandler{
			...
			msg.C_ClientCallGetParticipantByUserID:  c.groupGetParticipantByUserIDHandler,
			msg.C_ClientCallGetParticipantByConnId:  c.groupGetParticipantByConnIdHandler,
			msg.C_ClientCallGetParticipantList:      c.groupGetParticipantListHandler,
			msg.C_ClientCallMuteParticipant:         c.groupMuteParticipantHandler,
