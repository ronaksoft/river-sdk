...
func (c *call) initParticipants(callID int64, participants []*msg.PhoneParticipant, bootstrap bool) {
    fn := func(callParticipants map[int32]*msg.CallParticipant, callParticipantMap map[int64]int32) (map[int32]*msg.CallParticipant,
            map[int64]int32,
    ) {
        for _, participant := range participants {
...
func (c *call) initManyConnections(peer *msg.InputPeer, callID int64, initiator, video bool, request *UpdatePhoneCall) (res *msg.PhoneCall,
        err error,
) {
...
func (c *call) callUser(
        peer *msg.InputPeer, initiator bool, phoneParticipants []*msg.PhoneParticipantSDP, callID int64, video bool,
...
func (c *call) callUserSingle(peer *msg.InputPeer, phoneParticipant *msg.PhoneParticipantSDP, callID int64, video bool) (res *msg.PhoneCall,
        err error,
) {
    randomID := domain.RandomInt64(0)
