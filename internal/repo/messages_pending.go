...
func (r *repoMessagesPending) UpdateClientMessageMedia(
        pm *msg.ClientPendingMessage, totalParts int32, mediaType msg.InputMediaType, fileLocation *msg.FileLocation,
) error {
